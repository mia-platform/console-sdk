...
const _resourcesSchema = {
  $id: 'software-catalog-template-resources.schema.json',
  ...
  required: ['services'],
  title: 'Software Catalog template resources',
  type: 'object',
} as const satisfies JSONSchema
...
const typeDefinition: CatalogItemTypeDefinition = {
  ...
  metadata: {
    ...
    description: 'A basic repository with boilerplate code to start creating a microservice.',
    icon: {
    ...
    documentation: {
      type: 'external',
      url: 'https://docs.mia-platform.eu/docs/software-catalog/items-manifest/template',
    },
