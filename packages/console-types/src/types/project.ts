...
import { DEPLOYMENT_TYPES, ENVIRONMENTS_VARIABLES_TYPES, REPOSITORY_TYPES, DOCKER_IMAGE_NAME_SUGGESTION_TYPES, PROMETHEUS_OPERATOR, PULL_DEPLOY_STRATEGY, PUSH_DEPLOY_STRATEGY } from '../constants/project'
