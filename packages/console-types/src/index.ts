...
import { Provider, ProviderCapability, ZZ_CONTAINER_REGISTRY_HOSTNAME_REGEX, providerSchema } from './types/provider'
...
export {
  ...
  ZZ_CONTAINER_REGISTRY_HOSTNAME_REGEX as CONTAINER_REGISTRY_HOSTNAME_REGEX,
}
