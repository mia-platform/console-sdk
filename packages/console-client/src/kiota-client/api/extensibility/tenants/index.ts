...
/**
 * Builds and executes requests for operations under /api/extensibility/tenants
 */
export interface TenantsRequestBuilder extends BaseRequestBuilder<TenantsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.extensibility.tenants.item collection
 ...
 */
export const TenantsRequestBuilderUriTemplate = "{+baseurl}/api/extensibility/tenants";
/**
